...
function [signal, variance, chan_names, pnts, rate, xmin, xmax, nsweeps]=loadavg_dani( FILENAME)
...
%	Az elozo 2 sor ki lett veve, hogy a csd keszitesnel ne irjon ki
%	mindenfele adatokat.
...
% signal = zeros( chan, pnts*nsweeps); %lehet, hogy nem kell
